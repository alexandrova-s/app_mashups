...
def replace_vocals(voc1, voc2, full_vocal1, full_vocal2, accompaniament):
    list_of_minima = []
    ...
    for index_of_minimum in sorted_indexes:
        ...
        print(f"Podmiana w: {to_replace[0].start}")
        vocal_replacement = full_vocal2[to_replace[1][0].stop:to_replace[1][0].start]
        accompaniament = accompaniament.overlay(vocal_replacement, position=to_replace[0].start)
